...
<body>
	...
	?>
	<div class="container">
		<h1 class="text-center">Alta de veterinario</h1>
		<form action="#" id="formulario" method="POST" onsubmit="event.preventDefault(); veterinario.alta($('#nombre').val(), $('#correo').val(), $('#telefono').val(), $('#direccion').val(), $('#horario').val())">
